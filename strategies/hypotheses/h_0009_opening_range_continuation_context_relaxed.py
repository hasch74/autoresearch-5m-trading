"""h_0009 — Opening-range continuation with relaxed context gates.

Variant of h_0007:
  - Only session context gates are relaxed.
  - RVOL, ATR regime, and trigger filters remain unchanged.
"""
...
class OpeningRangeContinuationContextRelaxed:
    """First-hour continuation with relaxed gap/return context gating."""

    name: str = "opening_range_continuation_context_relaxed"
    version: str = "0.1"
    hypothesis_id: str = "h_0009"
    ...
    min_session_gap_pct: float = -0.002
    min_ret_open_to_now: float = 0.0005
