"""h_0008 — Opening-range continuation with relaxed RVOL gate.

Variant of h_0007:
  - Only RVOL threshold is relaxed.
  - Context and trigger filters remain unchanged.
"""
...
class OpeningRangeContinuationRvolRelaxed:
    """First-hour opening-range continuation; RVOL-only relaxation variant."""

    name: str = "opening_range_continuation_rvol_relaxed"
    version: str = "0.1"
    hypothesis_id: str = "h_0008"
